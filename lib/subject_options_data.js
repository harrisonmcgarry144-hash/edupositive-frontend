...
export const SUBJECT_OPTIONS = {
  "English Literature": {
    ...
    categories: [
      ...
      { name: "Poetry - Post-2000 (Paper 3A)", options: ["Poems of the Decade (Forward Books Anthology 2002-11) - ALL students"] },
      { name: "Poetry - Pre/Post-1900 Collection (Paper 3B)", options: ["Medieval Poetry & Chaucer", "Metaphysical Poetry (Donne, Marvell)", "Romantic Poetry (Wordsworth, Shelley, Keats)", "Victorian Poetry (Tennyson, Browning, Rossetti, Hardy)", "Modernism (Auden, Eliot, Cummings)", "The Movement (Larkin, Jennings, Porter)", "Duffy - Feminine Gospels", "Heaney - Death of a Naturalist", "Plath - Ariel", "Owen - War Poems", "Blake - Songs of Innocence and Experience"] },
    ]
  },
  "History": {
